...
enum camera_status{
    noramal,
    face_registered,
    recognized_face_found,
    unrecognized_face_found
};

camera_status message = noramal;
...
void esp_mesh_p2p_tx_main(void *arg)
{
    ...
    while (is_running) {
        ...
        tx_buf[25] = (message >> 24) & 0xff;
        tx_buf[24] = (message >> 16) & 0xff;
        tx_buf[23] = (message >> 8) & 0xff;
        tx_buf[22] = (message >> 0) & 0xff;
        if (send_count % 2) {
